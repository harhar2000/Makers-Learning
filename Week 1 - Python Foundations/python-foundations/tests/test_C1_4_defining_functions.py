from lib.C1_4_defining_functions import *
...
def test_say_goodbye_to():
    assert say_goodbye_to("Sam") == "Goodbye, Sam!"
...
def test_divide_three():
    assert divide_three(99) == True
    assert divide_three(98) == False
...
def test_multiply_number_strings():
    assert multiply_number_strings("5", "10") == 50
