from lib.C3_2_classes import *


class TestGreeter():

    def test_hello(self):
        subject = Greeter('Azrael')
        assert subject.say_hello() == 'Hello, Azrael!'

    def test_goodbye(self):
        subject = Greeter('Morticius')
        assert subject.say_goodbye() == 'Goodbye, Morticius!'

    def test_good_night(self):
        subject = Greeter('Jo')
        assert subject.say_goodnight() == 'Goodnight, Jo!'

    def test_good_morning(self):
        subject = Greeter('Jo')
        assert subject.say_goodmorning() == 'Good Morning, Jo!'
