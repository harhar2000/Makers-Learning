from lib.password_manager2 import PasswordManager2
...
class TestPasswordManager2():
    ...
    def test_sort_reverse_alphabetically(self):
        ...
        password_manager.add('acebook', '$12345678')
        password_manager.add('makersbnb', '@12345678')
        assert password_manager.sort_services_by('service', reverse=True) == [
            'makersbnb',
            'baidu',
            'acebook'
        ]
    ...
    def test_sort_reverse_chronologically(self):
        ...
        assert password_manager.sort_services_by('added_on', reverse=True) == [
            'makersbnb',
            'acebook',
            'baidu'
        ]