from lib.C2_1_lists_and_dictionaries import *
...
def test_i_joined_the_beatles():
    assert i_joined_the_beatles("yoko") == [
...
def test_new_band_member():
    assert new_band_member({"bass": "flea"}) == {
        "vocalist": "miss piggy", "lead_guitar": "scooter", "bass": "flea"}
    assert new_band_member({'grawgwa': 'gwa'}) == {
        'vocalist': 'miss piggy', 'lead_guitar': 'scooter', 'bass': 'flea', 'grawgwa': 'gwa'}
